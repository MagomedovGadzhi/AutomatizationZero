...
public class HelperXmlTest {
    ...
    void testXmlUserTable() throws IOException {
        ...
        String xmlBody = "<item><action>api</action><created_on>2020-09-26 23:07:34</created_on><id>10</id><updated_on>2020-09-26 23:07:34</updated_on><user_id>6</user_id><value>6218bbecc4dec9fce01dd1b7f26cef55e9c4dfb4</value></item>" +
        ...
        Assertions.assertTrue(result.contains(xmlBody));
    }
    ...
    void testXmlProjectsTable() throws IOException {
        ...
        String xmlBody = "<item><description>дескрипшен</description><homepage>нет</homepage><id>1</id><is_public>true</is_public><name>Тестовый проект</name></item>" +
    ...
    void testXmlRolesTable() throws IOException {
        ...
        String xmlBody = "<item><builtin>1</builtin><id>1</id><is_assignable>true</is_assignable><name>Non member</name><position>0</position></item>" +
